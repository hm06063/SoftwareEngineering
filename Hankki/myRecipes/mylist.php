<?php
	...
	$pdo = db_connect(); 
	$userID = $_SESSION["ID"];
	$sql = "select * from whalsrl5650.Recipe where userID = '$userID' order by recipeID desc";
   ...
   <link rel="stylesheet" href="../css/bootstrap.min.css" type="text/css">
	...
	<div class="container">
		<div class="float-right">
			<button type="button" onclick="location.href='mylist.php'" class="btn btn-outline-primary btn-lg">목록</button>
